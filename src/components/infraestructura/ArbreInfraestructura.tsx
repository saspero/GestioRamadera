...
import { ChevronDown, ChevronRight, Plus, Pencil, Warehouse, Layers, Grid2x2 } from 'lucide-react'
...
type ArbreInfraestructuraProps = {
  ...
  /** Si false (rol Treballador), s'amaguen tots els botons de creació/edició. */
  potEditar: boolean
        ...
        return (
          <div key={ubicacio.id} className="bg-white rounded-lg border border-gray-200">
            ...
            <div className="flex items-center gap-2 px-3 py-3">
              ...
              <span className="font-semibold text-gray-900 flex-1">{ubicacio.nom}</span>
              {potEditar && (
                <>
                  <button
                  ...
                  return (
                    <div key={zona.id} className="border-l-2 border-gray-100 pl-3">
                      <div className="flex items-center gap-2 py-2">
                        ...
                        <span className="text-gray-800 flex-1">{zona.nom}</span>
                        ...
                        <div className="pl-8 pb-2 space-y-1">
                          ...
                          {zona.corts.map((cort) => (
                            ...
                            >
                              ...
                              <span className="text-sm text-gray-700 flex-1">{cort.codiCort}</span>
