 ...
 * per a l'esquelet. La invalidació de queryKeys.sanitari.medicaments
 * ja la fa useImportarMedicaments() internament.
...
export function ModalImportarMedicaments({
  ...
  return (
    <Modal titol="Carregar CSV de fàrmacs" onTancar={onTancar} mida="xl" peu={peu}>
